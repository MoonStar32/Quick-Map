...
class _MapObjectCollectionExample extends StatefulWidget {
  @override
  _MapObjectCollectionExampleState createState() =>
      _MapObjectCollectionExampleState();
}

class _MapObjectCollectionExampleState
    extends State<_MapObjectCollectionExample> {
                ...
                ControlButton(
                    onPressed: () async {
                      ...
                      final mapObject = MapObjectCollection(
                        ...
                        onTap: (MapObjectCollection self, Point point) =>
                    ...
                    onPressed: () async {
                      ...
                      final mapObject =
                          mapObjects.firstWhere((el) => el.mapId == mapObjectId)
                              as MapObjectCollection;

                      setState(() {
                        mapObjects[mapObjects.indexOf(mapObject)] =
                            mapObject.copyWith(mapObjects: [
                          CircleMapObject(
                            mapId: MapObjectId('circle'),
                            circle: Circle(
                                radius: 10000,
